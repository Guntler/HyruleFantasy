...
(function($) {
    ...
    /** @scope me.debug.Panel.prototype */
    {
        ...
        init : function(showKey, hideKey) {
            ...
            // clickable areas
            this.area.renderHitBox = new me.Rect(160*this.mod,5*this.mod,15*this.mod,15*this.mod);
            this.area.renderVelocity = new me.Rect(165*this.mod,18*this.mod,15*this.mod,15*this.mod);

            this.area.renderQuadTree = new me.Rect(270*this.mod,5*this.mod,15*this.mod,15*this.mod);
            this.area.renderCollisionMap = new me.Rect(270*this.mod,18*this.mod,15*this.mod,15*this.mod);
